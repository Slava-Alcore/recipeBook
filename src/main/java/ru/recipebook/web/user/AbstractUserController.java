...
import ru.recipebook.util.exception.ModificationRestrictionException;
import ru.recipebook.Profiles;
...
public abstract class AbstractUserController {
    ...
    private void checkModificationAllowed(int id) {
        if (modificationRestriction && id < AbstractIdEntity.USER_SEQ + 2) {
